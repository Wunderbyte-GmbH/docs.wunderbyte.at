...
(defined in [`settings.php`](https://github.com/Wunderbyte-GmbH/moodle-mod_booking/blob/main/settings.php), section "Unenrol users without access").
...
Checks are created from event observers registered in [`db/events.php`](https://github.com/Wunderbyte-GmbH/moodle-mod_booking/blob/main/db/events.php) and
handled in [`classes/observer.php`](https://github.com/Wunderbyte-GmbH/moodle-mod_booking/blob/main/classes/observer.php):
...
- The 15-minute delay is set in
  [`checkanswers.php`](https://github.com/Wunderbyte-GmbH/moodle-mod_booking/blob/main/classes/local/checkanswers/checkanswers.php) via
...
Constants live in
[`checkanswers.php`](https://github.com/Wunderbyte-GmbH/moodle-mod_booking/blob/main/classes/local/checkanswers/checkanswers.php):
...
- A new check only runs automatically when something queues it. To wire it to a Moodle event, add
  an observer in [`db/events.php`](https://github.com/Wunderbyte-GmbH/moodle-mod_booking/blob/main/db/events.php) that calls
...
| File | Role |
|------|------|
| [`classes/local/checkanswers/checkanswers.php`](https://github.com/Wunderbyte-GmbH/moodle-mod_booking/blob/main/classes/local/checkanswers/checkanswers.php) | Orchestrator: constants, task creation, option processing, check/action discovery |
| [`classes/local/checkanswers/checks/cmvisibility.php`](https://github.com/Wunderbyte-GmbH/moodle-mod_booking/blob/main/classes/local/checkanswers/checks/cmvisibility.php) | `CHECK_CM_VISIBILITY` — activity user-visibility check |
| [`classes/local/checkanswers/checks/enrolledincourse.php`](https://github.com/Wunderbyte-GmbH/moodle-mod_booking/blob/main/classes/local/checkanswers/checks/enrolledincourse.php) | `CHECK_COURSE_ENROLLMENT` — course enrolment check |
| [`classes/local/checkanswers/actions/deleteanswer.php`](https://github.com/Wunderbyte-GmbH/moodle-mod_booking/blob/main/classes/local/checkanswers/actions/deleteanswer.php) | `ACTION_DELETE` — deletes the booking answer |
| [`classes/task/check_answers.php`](https://github.com/Wunderbyte-GmbH/moodle-mod_booking/blob/main/classes/task/check_answers.php) | Ad-hoc task that runs the checks after the delay |
| [`classes/observer.php`](https://github.com/Wunderbyte-GmbH/moodle-mod_booking/blob/main/classes/observer.php) | Event observers that queue the checks |
| [`db/events.php`](https://github.com/Wunderbyte-GmbH/moodle-mod_booking/blob/main/db/events.php) | Event → observer registration |
| [`settings.php`](https://github.com/Wunderbyte-GmbH/moodle-mod_booking/blob/main/settings.php) | The two admin settings (PRO) |
| [`tests/checkanswers/`](https://github.com/Wunderbyte-GmbH/moodle-mod_booking/blob/main/tests/checkanswers) | PHPUnit coverage for the subsystem |
