...
- [Developer guide: Booking Agent workflow](https://github.com/Wunderbyte-GmbH/moodle-mod_booking/blob/main/bookingextension/agent/classes/local/wbagent/README_AGENT.md)
